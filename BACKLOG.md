...
- Reverse geocoding: show a readable location name (e.g., city or landmark) instead of raw lat/long coordinates
...
- Date range filters on both Map and List views: let the user filter sightings by Last Hour, Last Day, Last Week, Last Month, or All Time.
